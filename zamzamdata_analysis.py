...
models = [
    {"name": "Rockyou", "filename": "zamzamrockyou{}_results.txt", "color": "b", "marker": "o", "linestyle": "-"},
    {"name": "Wikiscraper", "filename": "zamzamscrape{}_results.txt", "color": "r", "marker": "s", "linestyle": "-"},
    {"name": "Llama3.1", "filename": "zamzamllama31{}_results.txt", "color": "green", "marker": "^", "linestyle": "-"},
    {"name": "PCFG-Wikiscraper", "filename": "zamzamscrapepcfg{}_results.txt", "color": "r", "marker": "s", "linestyle": "--"},
    {"name": "PCFG-Llama3.1", "filename": "zamzamllamapcfg{}_results.txt", "color": "green", "marker": "^", "linestyle": "--"}
]
...
def plot_recoveries():
    ...
    plt.title('Zamzamdirect Leak Recovery with the OneRuleToRuleThemStill Ruleset', fontsize=14)
