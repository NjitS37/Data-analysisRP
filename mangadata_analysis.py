...
models = [
    {"name": "Rockyou", "filename": "mangarockyou{}_results.txt", "color": "b", "marker": "o", "linestyle": "-"},
    {"name": "Wikiscraper", "filename": "mangascrape{}_results.txt", "color": "r", "marker": "s", "linestyle": "-"},
    {"name": "Llama3.1", "filename": "mangallama31{}_results.txt", "color": "green", "marker": "^", "linestyle": "-"},
    {"name": "PCFG-Wikiscraper", "filename": "mangascrapepcfg{}_results.txt", "color": "r", "marker": "s", "linestyle": "--"},
    {"name": "PCFG-Llama3.1", "filename": "mangallamapcfg{}_results.txt", "color": "green", "marker": "^", "linestyle": "--"}
]
...
def plot_recoveries():
    ...
    plt.title('Mangatraders Leak Recovery with the OneRuleToRuleThemStill Ruleset', fontsize=14)
