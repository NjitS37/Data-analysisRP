...
models = [
    {"name": "Rockyou", "filename": "minecraftrockyou{}_results.txt", "color": "b", "marker": "o", "linestyle": "-"},
    {"name": "Wikiscraper", "filename": "minecraftscrape{}_results.txt", "color": "r", "marker": "s", "linestyle": "-"},
    {"name": "Llama3.1", "filename": "minecraftllama31{}_results.txt", "color": "green", "marker": "^", "linestyle": "-"},
    {"name": "PCFG-Wikiscraper", "filename": "minecraftscrapepcfg{}_results.txt", "color": "r", "marker": "s", "linestyle": "--"},
    {"name": "PCFG-Llama3.1", "filename": "minecraftllamapcfg{}_results.txt", "color": "green", "marker": "^", "linestyle": "--"}
]
...
def plot_recoveries():
    ...
    plt.title('Planetminecraft Leak Recovery with the OneRuleToRuleThemStill Ruleset', fontsize=14)
